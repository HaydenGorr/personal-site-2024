...
export default function BottomTextBox({aiSearching, getTagsFromAI, add_to_keywords, chipsText, selectedChips_text, setUserText, userText, page_title_callback, SendMessageToAI}) {
